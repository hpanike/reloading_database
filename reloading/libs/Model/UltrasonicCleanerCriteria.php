...
require_once("DAO/UltrasonicCleanerCriteriaDAO.php");

/**
 * The UltrasonicCleanerCriteria class extends UltrasonicCleanerDAOCriteria and is used
 ...
 * @version 1.0
 */
class UltrasonicCleanerCriteria extends UltrasonicCleanerCriteriaDAO
{
