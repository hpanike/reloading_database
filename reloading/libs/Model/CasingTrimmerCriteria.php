...
require_once("DAO/CasingTrimmerCriteriaDAO.php");

/**
 * The CasingTrimmerCriteria class extends CasingTrimmerDAOCriteria and is used
 ...
 * @version 1.0
 */
class CasingTrimmerCriteria extends CasingTrimmerCriteriaDAO
{
