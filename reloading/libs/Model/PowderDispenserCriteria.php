...
require_once("DAO/PowderDispenserCriteriaDAO.php");

/**
 * The PowderDispenserCriteria class extends PowderDispenserDAOCriteria and is used
 ...
 * @version 1.0
 */
class PowderDispenserCriteria extends PowderDispenserCriteriaDAO
{
