...
require_once("DAO/HandPrimerCriteriaDAO.php");

/**
 * The HandPrimerCriteria class extends HandPrimerDAOCriteria and is used
 ...
 * @version 1.0
 */
class HandPrimerCriteria extends HandPrimerCriteriaDAO
{
