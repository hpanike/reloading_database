...
require_once("DAO/ShellHolderCriteriaDAO.php");

/**
 * The ShellHolderCriteria class extends ShellHolderDAOCriteria and is used
 ...
 * @version 1.0
 */
class ShellHolderCriteria extends ShellHolderCriteriaDAO
{
