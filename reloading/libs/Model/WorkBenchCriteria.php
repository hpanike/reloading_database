...
require_once("DAO/WorkBenchCriteriaDAO.php");

/**
 * The WorkBenchCriteria class extends WorkBenchDAOCriteria and is used
 ...
 * @version 1.0
 */
class WorkBenchCriteria extends WorkBenchCriteriaDAO
{
