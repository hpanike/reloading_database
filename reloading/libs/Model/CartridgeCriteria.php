...
require_once("DAO/CartridgeCriteriaDAO.php");

/**
 * The CartridgeCriteria class extends CartridgeDAOCriteria and is used
 ...
 * @version 1.0
 */
class CartridgeCriteria extends CartridgeCriteriaDAO
{
