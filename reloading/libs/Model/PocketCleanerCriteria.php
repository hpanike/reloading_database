...
require_once("DAO/PocketCleanerCriteriaDAO.php");

/**
 * The PocketCleanerCriteria class extends PocketCleanerDAOCriteria and is used
 ...
 * @version 1.0
 */
class PocketCleanerCriteria extends PocketCleanerCriteriaDAO
{
