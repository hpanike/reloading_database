...
require_once("DAO/CleaningSolutionCriteriaDAO.php");

/**
 * The CleaningSolutionCriteria class extends CleaningSolutionDAOCriteria and is used
 ...
 * @version 1.0
 */
class CleaningSolutionCriteria extends CleaningSolutionCriteriaDAO
{
