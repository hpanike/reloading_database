...
GlobalConfig::$CONNECTION_SETTING->DBName = "reloading";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "admin";
...
/** the root url of the application with trailing slash, for example http://localhost/reloading/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'reloading/';
